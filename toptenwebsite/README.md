...
<body>
  ...
  <img src="Images/Allsports.png" class="img-fluid" alt="...">
    ...
    <header>
      <div class="d-flex flex-row nav-bar justify-content-around">
        <ul class="nav">
          ...
          <div class="p-2">
            <li class="nav-item"><a href="nba.html" class="nav-link">NBA</a></li>
          </div>
          <div class="p-2">
            <li class="nav-item"><a href="nflPage.html" class="nav-link">NFL</a></li>
          </div>
          <div class="p-2">
            <li class="nav-item"><a href="mlb.html" class="nav-link">MLB</a></li>
          </div>
        </ul>
      </div>
    </header>
    ...
    <div class="row">
        ...
        <div id="slider3" class="carousel slide mb-5" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img class="d-block w-100 h-auto" src="Images/CurryLebron.png">
            </div>
            <div class="carousel-item">
              <img class="d-block w-100 h-auto" src="Images/BaseballCelebrate.png">
            </div>
            <div class="carousel-item">
              <img class="d-block w-100 h-auto" src="Images/RaidersTD.png">
            </div>
          </div>
      ...
      <div class="row">
        ...
        <div class="col-6 text-center">
          ...
          <div class="card">
            <img src="Images/Eagles.jpg" class="card-img-top img-fluid" alt="...">
            <div class="card-body">
          ...
          <div class="card">
            <img src="Images/jacobs.png" class="card-img-top img-fluid" alt="...">
            <div class="card-body">
              <div class="card-title">
          ...
          <div class="card">
            <img src="Images/adams.png" class="card-img-top img-fluid" alt="...">
            <div class="card-body">
              <div class="card-title">
